...
```bash
# 1. 克隆仓库
git clone https://github.com/mokeal1/TalkifyTTS.git
cd TalkifyTTS
...
[![Star History Chart](https://api.star-history.com/image?repos=mokeal1/TalkifyTTS&type=date&legend=top-left)](https://www.star-history.com/?repos=mokeal1%2FTalkifyTTS&type=date&legend=bottom-right)